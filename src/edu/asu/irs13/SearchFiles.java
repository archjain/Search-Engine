...
public class SearchFiles {
	public static void main(String[] args) throws Exception
	{
		...
		//1075, 1077, 1073, 1074 , 787, 360, 359, 376
		Document d = r.document(369);
		...
		//TermDocs tdd=r.termDocs();
	    //tdd.doc();
		//String d2_url = r.document(5).getFieldable("path").stringValue().replace("%%", "/");
		//System.out.println("adsasd"+d2_url);
